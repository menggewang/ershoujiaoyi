				    ...
				    <div class="NewContainer370">
						...
						<div class="Slot">
							<table width="100%" cellspacing="5" border="0">
							    ...
							    <tr>
							       <td width="65%" align="left"><a href="<%=path %>/goodsDetailQian.action?goodsId=<s:property value="#goods.goodsId"/>"><s:property value="#goods.goodsName" escape="false"/></a></td>
							       <td width="35%" align="right"><s:property value="#goods.goodsShijian"/></td>
							    </tr>
							    </s:iterator>
							</table>
	                    </div>

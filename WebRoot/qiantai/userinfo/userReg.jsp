	...
	<head>
		...
		<script language="javascript">
		    ...
		    function check1()
		    {
		        ...
		        if(document.form1.userTel.value !="" && isMobile(document.form1.userTel.value)==false)
		        {
		            alert('请输入正确手机号码！');
		            return false
		        }
	...
	<body>
			<form action="<%=path %>/userReg.action" name="form1" method="post">
				<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
					...
					<tr>
						<th height="40" colspan="2" bgcolor="#FFFFFF" class="f12b-red" style="font-size: 11px;">
							<font color="red" style="font-size: 13px;"> <% if( request.getAttribute("msg") != null ) out.print( request.getAttribute("msg") ); %> </font>
						</th>
					</tr>
					<tr>
